...
import com.heheda.ticket.web.vo.ApiRequest;
...
public class DecodeRequestBodyAdvice implements RequestBodyAdvice {
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter methodParameter, Type type, Class<? extends HttpMessageConverter<?>> aClass) throws IOException {
        ...
        Class clazzName = type.getClass();
//        String clazzName = typeName.substring(typeName.lastIndexOf('.')+1, typeName.length());
        try {
    ...
    class MyHttpInputMessage implements HttpInputMessage {
        ...
        public MyHttpInputMessage(HttpInputMessage inputMessage) throws Exception {
            ...
            String body = StreamUtil.getStringBody(inputMessage.getBody());
            this.body=IOUtils.toInputStream(easpString(body));
         ...
         * @return
         */
        public String easpString(String requestData) throws ClassNotFoundException, IllegalAccessException, InstantiationException {

            if(requestData != null && !requestData.equals("")){


                //                ApiRequest apiRequest = JSONObject.parseObject(requestData, ApiRequest.class);
